  ...
  <div>
    ...
    <VCard>
          ...
          <tbody>
            <tr v-for="(item, index) in data.data" :key="index">
              ...
              <td class="text-center">
                ...
                |
                <IconBtn>
                  <VIcon class="text-primary" :icon="'tabler-trash-filled'" @click="openDeletePopup(item.id)" />
                  <VTooltip activator="parent" location="start">
                    Delete Data
                  </VTooltip>
                </IconBtn>
      ...
      <div class="d-flex align-center justify-sm-space-between justify-center flex-wrap gap-3 pa-5 pt-3">
        ...
        <VPagination v-model="options.page" :length="Math.ceil(data.total / options.itemsPerPage)" :total-visible="$vuetify.display.xs
          ? 1
