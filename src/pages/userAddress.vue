            ...
            <VCardText class="d-flex flex-wrap py-4 gap-4">
                ...
                <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
                    ...
                    <div style="inline-size: 12rem">
                        <AppTextField v-model="options.search" placeholder="Search By Address" density="compact"
                            @keyup="fetchData()" />
                    </div>
                </div>
            </VCardText>
                ...
                <v-data-table class="text-no-wrap" fixed-header>
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-center">Person Name</th>
                            <th class="text-uppercase text-center">Phone Number</th>
                            <th class="text-uppercase text-center">Address</th>
                            <th class="text-uppercase text-center">Landmark</th>
                            <th class="text-uppercase text-center">Default Address</th>
